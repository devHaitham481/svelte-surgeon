export const SOURCE_FILE_PATTERN = /\.(tsx?|jsx?|svelte)$/;

export const SVELTE_FILE_PATTERN = /\.(tsx?|jsx?|svelte)$/;
...
export const SCORE_API_URL = "https://www.svelte.doctor/api/score";

export const SHARE_BASE_URL = "https://www.svelte.doctor/share";
