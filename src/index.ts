...
import { SVELTE_FILE_PATTERN } from "./constants.js";
import type { Diagnostic, DiffInfo, ProjectInfo, SvelteDoctorConfig, ScoreResult } from "./types.js";
...
export type { Diagnostic, DiffInfo, ProjectInfo, SvelteDoctorConfig, ScoreResult };
...
export const diagnose = async (
  ...
  const svelteIncludePaths = isDiffMode
    ? includePaths.filter((filePath) => SVELTE_FILE_PATTERN.test(filePath))
    : undefined;
